...
public interface PersonalDao extends CRUDInterface<Personal> {
    ...
    void changeEmailAddressByPositionAndName(String newEmailAddress, String position, Personal personal) throws ConnectionDBException, SQLException;
    void changePhoneNumberByPositionAndName(String newPhoneNumber, String position, Personal personal) throws ConnectionDBException, SQLException;
