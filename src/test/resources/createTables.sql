...
CREATE TABLE IF NOT EXISTS assortment_types (
...
CREATE TABLE IF NOT EXISTS personal_phone_numbers (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS personal_email_addresses (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS orders_and_assortment(
    id SERIAL PRIMARY KEY,
    order_id INTEGER,
